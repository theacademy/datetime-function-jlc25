...
public class DateTimeFunctions {
	...
	public static String getTimeDifference(LocalDate date1, LocalDate date2) {
		...
		int numYears = timeDifference.getYears();
		int numMonths = timeDifference.getMonths();
		int numDays = timeDifference.getDays();

		return String.format("Years-%s:Months-%s:Days-%s", numYears, numMonths, numDays);
		//YOUR CODE ENDS HERE
